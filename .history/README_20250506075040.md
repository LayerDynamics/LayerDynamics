...
- [ MDX-to-JSON ](https://github.com/LayerDynamics/mdx-to-json): A tool for converting MDX files to JSON format, facilitating easier data manipulation and integration in various applications.