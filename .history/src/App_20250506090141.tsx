...
import viteLogo from '/vite.svg'mponents/sections/Intro/IntroContainer'
import './App.css'from '@/components/ui/button'
import Layout from './layout/layout'import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from '@/components/ui/card'
import IntroContainer from './components/sections/Intro/IntroContainer'absContent, TabsList, TabsTrigger } from '@/components/ui/tabs'
import { Button } from '@/components/ui/button'
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from '@/components/ui/card'function App() {
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs'ctiveTab, setActiveTab] = useState("about")
...
roContainer />
  return (
    <>
      <div>iv className="mb-10 text-center">
